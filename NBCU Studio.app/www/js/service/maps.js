...
function getGeoLocation() {
    ...
    google.maps.event.addListener(GeoMarker, 'geolocation_error', function(e) {
                                  navigator.notification.alert('There was an error obtaining your position.',{},' ','Done');
                                  });
...
//adding marker properties here to display by infowindow.
    ...
    content+='<div class="popClick" style="float:left;width:95px;margin-left:0px;padding-left:5px;height:45px;line-height:45px;font-size:10px;color:#335;overflow:hidden;padding-right:10px;word-wrap:break-word;" onclick="showHidePop(this);">' + firstLocName +'</div>';
    ...
    content+='<div style="width:95px;margin-left:0px;padding-left:5px;height:45px;line-height:45px;font-size:10px;color:#335;padding-right:10px;overflow:hidden;margin-right:5px;word-wrap:break-word;">' + newmarker +'</div>';
            	content+='</a></div>';
        }
    var myOptions = {
    content: content
